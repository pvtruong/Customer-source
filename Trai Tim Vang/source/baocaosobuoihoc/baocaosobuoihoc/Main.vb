...
#Region "form dkloc"
    ...
    Sub GetQuery()
        ...
        query = query & "," & rpt.conn.ConvertToSQLType(frmdkloc.txtma_the.Text)
        query = query & "," & rpt.conn.ConvertToSQLType(frmdkloc.txtma_khoa_hoc.Text)
        query = query & "," & rpt.conn.ConvertToSQLType(frmdkloc.txtma_lop.Text)
