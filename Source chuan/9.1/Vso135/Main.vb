...
Public Class Frmmain
    ...
    Private Sub beforedelete(e As String)
        If conn.GetValue("if exists(select stt_rec_so1 from dhd2 where stt_rec_so1 ='" & e & "') select 1 else select 0 ") = "1" Then
            MsgBox("Không thể xoá đơn hàng này do đã được xuất hoá đơn",, Clsql.AboutMe.Name)
