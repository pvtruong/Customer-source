...
finnish:
    ...
    Sub luu()
        ...
        Try
            ...
            querysave = querysave & Chr(13) & rpt.conn.GetInsertQueryFromDatatable(dvhd.Table, "stt_rec ='" & grd.CurrentRow.Cells("stt_rec").Value & "' and ma_kh ='" & grd.CurrentRow.Cells("ma_kh").Value & "' and pb_dn = 1 and tk_no ='" & grd.CurrentRow.Cells("tk_no").Value & "'", "tdttco")
