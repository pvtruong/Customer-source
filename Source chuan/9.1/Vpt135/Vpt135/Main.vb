...
Public Class Frmmain
    ...
    Sub detailHD_load(ByVal e As String)
        ...
        End If
        Dim query As String = "Exec GetInvoice4Rec_load ''," & conn.ConvertToSQLType(frmin.Txtngay_ct.Value) & "," & Voucher.Action & "," & conn.ConvertToSQLType(e)

        Voucher.Tabdetails("tdttno").Datatable = conn.GetDatatable(query)
        'Try
