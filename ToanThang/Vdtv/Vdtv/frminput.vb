...
#End Region
    ...
    Private Sub txtma_ct_TextChanged(sender As Object, e As EventArgs) Handles txtso_ct.TextChanged
    ...
    Private Sub btnLuu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLuu.Click
        ...
        Select Case formtask.task
            ...
            '            query = query & "," & conn.ConvertToSQLType(Me.Txtngay_cn.Value)
            '            If Voucher.Action = ClsSV31.Voucher20.Actions.ADD Then
            '                query = query & ",1"
            '            Else
            '                query = query & ",2"
            ...
            '                    r.Item("ma_ct") = "PT1"
            '                    r.Item("loai_tt") = "1"
            '                    r.Item("ngay_ct") = Me.Txtngay_cn.Value
            '                    r.Item("so_ct") = Me.txtma_dt.Text
    ...
    Function save() As Boolean
        ...
        If Voucher.CheckSoCT(Txtngay_ct.Value, txtma_dt.Text) = False Then
            Return False
            Exit Function
        End If
        ...
        '                             & "," & conn.ConvertToSQLType(Txtngay_cn.Value) _
        '                            & "," & ps_no & "," & ps_no_nt)
        '            If vuot > 0 Then
    ...
    Sub tinh_tong_tien()
        ...
        t_tien = t_tien_nt * txtty_gia.Value
        ...
        'Txtt_tien.Value = t_tt
        'Txtt_tien_nt.Value = t_tt_nt
    End Sub
