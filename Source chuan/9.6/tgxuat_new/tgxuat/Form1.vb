Public Class Form1
    ...
    Private Sub calc()
        ...
        Dim tinh_theo_tt As String = Clsql.Others.Options("tg_theo_tt", conn)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            For Each r As DataRow In ds.Tables(0).Rows
                ...
                If stt_rec <> "" Then
                    ...
                    End If
                    If tinh_theo_tt = "1" Then
                        query = "select top 1 line from  " & dtable & " where stt_rec ='" & stt_rec & "' and ma_vt ='" & r.Item("ma_vt").ToString.Trim & "' and ma_kho ='" & r.Item("ma_kho").ToString.Trim & "' and ma_tt1 ='" & r.Item("ma_tt1").ToString.Trim & "' and ma_tt2 ='" & r.Item("ma_tt2").ToString.Trim & "' and ma_tt3 ='" & r.Item("ma_tt3").ToString.Trim & "' and ma_tt4 ='" & r.Item("ma_tt4").ToString.Trim & "' and ma_tt5 ='" & r.Item("ma_tt5").ToString.Trim & "' and ma_lo ='" & r.Item("ma_lo").ToString.Trim & "'"
                        Dim line As Integer = conn.GetValue(query)
                        query = "update " & dtable & " set tien_xuat = tien_xuat + " & r.Item("du") & ",tien_xuat_nt = tien_xuat_nt + " & r.Item("du") & " where line =" & line & " and  stt_rec ='" & stt_rec & "' and ma_vt ='" & r.Item("ma_vt").ToString.Trim & "' and ma_kho ='" & r.Item("ma_kho").ToString.Trim & "' and ma_tt1 ='" & r.Item("ma_tt1").ToString.Trim & "' and ma_tt2 ='" & r.Item("ma_tt2").ToString.Trim & "' and ma_tt3 ='" & r.Item("ma_tt3").ToString.Trim & "' and ma_tt4 ='" & r.Item("ma_tt4").ToString.Trim & "' and ma_tt5 ='" & r.Item("ma_tt5").ToString.Trim & "' and ma_lo ='" & r.Item("ma_lo").ToString.Trim & "'"
                        Try
                            conn.Execute(query)
                        ...
                        ClsSV31.Functions.Post(conn, ma_ct, mtable, stt_rec, 5)
                    Else
