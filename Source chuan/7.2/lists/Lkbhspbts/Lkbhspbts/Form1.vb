...
Public Class Frmmain
    ...
    Private Sub dmload(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If f.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            'sao chep tu ky truoc
            If f.chbcopy.Checked = True Then
                conn.Execute("ts_copyhspbts " & f.txtky.Value & "," & f.txtnam.Value)
            End If
            '
    ...
    Sub setuplookup()
        ...
        '    r("isnullable") = True
        'Next
        Dim ots As New AutoCompleteLookup(conn, "dmts", frmin.txtso_the_ts, "so_the_ts", True)
        ...
        ohd.SetValue("so_hd", frmin.ten_hd)
