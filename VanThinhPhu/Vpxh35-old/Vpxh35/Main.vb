...
Public Class Frmmain
    ...
    Sub beforeadd(ByVal e As String)
        ...
        'Voucher.Tabdetails(Voucher.TabFirst).lookups("ma_lo").oKey = "ma_dvcs='" & Reg.GetValue("unit") & "'"
    End Sub
    Sub beforeedit(ByVal e As String)
        ...
        'Voucher.Tabdetails(Voucher.TabFirst).lookups("ma_lo").oKey = "ma_dvcs='" & grd.CurrentRow.Cells("ma_dvcs").Value & "'"
        'Dim chx As Integer = conn.GetValue("exec checpxh " & conn.ConvertToSQLType(grd.CurrentRow.Cells("ma_dvcs").Value))
        'frmin.btnLuu.Enabled = (chx = 1)
        'frmin.btnluuandmoi.Enabled = (chx = 1)
    End Sub
