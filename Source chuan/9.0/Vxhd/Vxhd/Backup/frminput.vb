...
#End Region
    ...
    Sub tinh_tong_tien()
        ...
        txtt_thue_nt.Value = t_thue_nt + t_thue_ck_hd_nt
        txtt_thue.Value = t_thue + t_thue_ck_hd


        t_tt_nt = t_tien_nt - t_ck_nt - t_ck_hd_nt + t_thue_nt + t_thue_ck_hd_nt  'ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "t_hd_nt")
        t_tt = t_tien - t_ck - t_ck_hd + t_thue + t_thue_ck_hd 'ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "t_hd")
