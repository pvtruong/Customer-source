...
Public Class Frmmain
    ...
    'Dim ctr_diachi As List(Of Object) = Nothing
    'Dim crt_baohiem As List(Of Object) = Nothing
    ...
    Private Sub grd_RowEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grd.CellEnter
        ...
        ''kiem tra xem co dong nao dc chon ko ?
        ...
        '    If ctr_diachi Is Nothing Then
        '        ctr_diachi = ClsControl2.PropertyOfForm.getControls(dia_chi)
        '    End If
        '    ClsControl2.PropertyOfForm.SetValues4Control(datarow, ctr_diachi)

        '    If crt_baohiem Is Nothing Then
        '        crt_baohiem = ClsControl2.PropertyOfForm.getControls(bao_hiem)
        '    End If
        '    ClsControl2.PropertyOfForm.SetValues4Control(datarow, crt_baohiem)
...
#End Region
    ...
    End Sub
    Sub setlookup()
        ClsControl2.PropertyOfForm.Lookups(conn, Me, "dmnv")
        'ClsControl2.PropertyOfForm.Lookups(conn, frmin, "dmnv")
    End Sub
