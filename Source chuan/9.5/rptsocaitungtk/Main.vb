...
#Region "form dkloc"
    ...
    Sub GetQuery()
        query = "exec  TrialBalance " & rpt.conn.ConvertToSQLType(frmdkloc.Txttu_ngay.Value) & "," & rpt.conn.ConvertToSQLType(frmdkloc.TxtDen_ngay.Value) & "," & rpt.conn.ConvertToSQLType(frmdkloc.cbbma_dvcs.SelectedValue) & ",N'',99,0,0"
    End Sub
    Dim tk As String
