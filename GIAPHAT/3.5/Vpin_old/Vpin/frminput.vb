...
#End Region
    ...
    Sub tinh_tong_tien()
        ...
        t_ck_nt = ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "tien_ck_nt") + ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails("vdcanmang").gridDetailKeyin, "tien_ck_nt")
        t_ck = ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "tien_ck") + ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails("vdcanmang").gridDetailKeyin, "tien_ck")
        t_thue_nt = ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "tien_thue_nt") + ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails("vdcanmang").gridDetailKeyin, "tien_thue_nt")
        t_thue = ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "tien_thue") + ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails("vdcanmang").gridDetailKeyin, "tien_thue")
    ...
    Sub hide_show_control(ByVal ma_nt As String)
        ...
        If ag = "PGHstatus=4B5" And conn.GetValue("select admin from dmnsd where id ='" & Frmmain.txtuser.Text & "'") = False Then
            ...
            '
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("dien_giai").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("c").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("m").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("y").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("k").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("p1").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("p2").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("in").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("trang").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("don_gia").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_no").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_co").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("ty_le_ck").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_ck").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("ma_thue").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("thue_suat").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_thue_co").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_du").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").ReadOnly = True
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("so_lan").ReadOnly = True
        Else
            ...
            '
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("dien_giai").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("c").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("m").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("y").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("k").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("p1").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("p2").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("in").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("trang").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("don_gia").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_no").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_co").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("ty_le_ck").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_ck").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("ma_thue").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("thue_suat").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_thue_co").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tk_du").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").ReadOnly = False
            Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("so_lan").ReadOnly = False
        End If
        ...
        If ma_nt.Trim.ToUpper = ma_nt_ht.Trim.ToUpper Then
            ...
            ''
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").Visible = False
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").Visible = False
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").Visible = False

            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").HeaderText = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").HeaderText
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").HeaderText = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").HeaderText
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").HeaderText = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").HeaderText

            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").DefaultCellStyle.Format = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").DefaultCellStyle.Format
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").DefaultCellStyle.Format = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").DefaultCellStyle.Format
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").DefaultCellStyle.Format = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").DefaultCellStyle.Format
        ...
        Else
            ...
            ''
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").Visible = True
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").Visible = True
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").Visible = True

            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").HeaderText = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien").HeaderText.Trim & " " & cbbma_nt.Text
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").HeaderText = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck").HeaderText.Trim & " " & cbbma_nt.Text
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").HeaderText = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue").HeaderText.Trim & " " & cbbma_nt.Text

            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").DefaultCellStyle.Format = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_nt").HeaderCell.Tag.ToString.Split("?")(1)
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").DefaultCellStyle.Format = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_ck_nt").HeaderCell.Tag.ToString.Split("?")(1)
            'Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").DefaultCellStyle.Format = Voucher.Tabdetails("vdcanmang").gridDetailKeyin.Columns("tien_thue_nt").HeaderCell.Tag.ToString.Split("?")(1)
