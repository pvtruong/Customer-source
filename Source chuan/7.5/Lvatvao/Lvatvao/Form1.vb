...
Public Class Frmmain
    ...
    Sub setlookup()
        ...
        Dim oma_tc As New ClsLookup.AutoCompleteLookup(list.conn, "dmtc", frmin.txtma_tc, "ma_tc")
        oma_tc.SetValue("ten_tc", frmin.ten_tc)
        ...
        oma_thue.SetValue("tk_thue_no", frmin.txttk_thue_no)

        Dim otk_thue As New ClsLookup.AutoCompleteLookup(list.conn, "dmtk", frmin.txttk_thue_no, "tk")
