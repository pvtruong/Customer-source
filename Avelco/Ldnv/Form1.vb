...
Public Class Frmmain
    ...
    Private Sub dmload(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ClsLookup.AddItems.AddItemCbb(conn, "select ma_nt,ten_nt from dnt", frmin.cbbma_nt, "ten_nt", "ma_nt")
...
#End Region
    ...
    End Sub
    Sub setlookup()
        ClsLookup.AddItems.AddItemCbb(conn, "select ma,ten from tiengnhat where trang_thai=1 order by ma desc", frmin.cbbtieng_nhat, "ten", "ma")
        ClsLookup.AddItems.AddItemCbb(conn, "select ma,ten from tiengnhat where trang_thai=1 order by ma desc", cbbtieng_nhat, "ten", "ma")
    End Sub
