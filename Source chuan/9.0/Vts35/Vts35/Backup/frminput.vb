...
Public Class frminput
    ...
    Function save() As Boolean
        ...
        Else
            ...
            If oldso_the_ts <> Voucher.CurrentVoucher("so_the_ts") Then
                conn.Execute("EXEC ChangeSoTheTS '" & oldso_the_ts & "','" & Voucher.CurrentVoucher("so_the_ts") & "'")
            End If
        End If
    ...
    Function kiem_tra_so_the_ts() As Boolean
        ...
        Dim dttest As DataTable = conn.GetDatatable("select so_the_ts,stt_rec from mts where so_the_ts ='" & txtso_the_ts.Text.Trim & "'")
