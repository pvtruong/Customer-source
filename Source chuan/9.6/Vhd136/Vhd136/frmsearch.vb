...
Public Class frmsearch
    ...
    Private Sub frmsearch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim oNCC2search As New ClsLookup.AutoCompleteLookup(conn, "ldkh", txtma_kh, "ma_kh", False, False)


        Dim oKhoSearch As New ClsLookup.AutoCompleteLookup(conn, "dmbp", txtma_bp, "ma_bp", False, False)


        Dim oKhophi As New ClsLookup.AutoCompleteLookup(conn, "dmphi", txtma_phi, "ma_phi", False, False)


        Dim oKhodt As New ClsLookup.AutoCompleteLookup(conn, "dmdt", txtma_dt, "ma_dt", False, False)
