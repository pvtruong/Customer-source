...
Public Class Frmmain
    ...
    Sub SetUpLookup()
        If Clsql.Reg.GetValue("Language") = "Vi" Then
            ClsLookup.AddItems.AddItemCbb(Voucher.conn, "select inds,text from dmitemofcbb where form ='" & Voucherid & "' and name = 'status' order by inds", frmin.cbbstatus, "text", "inds")
            ClsLookup.AddItems.AddItemCbb(Voucher.conn, "select inds,text from dmitemofcbb where form ='" & Voucherid & "' and name = 'ma_gd' order by inds", frmin.cbbma_gd, "text", "inds")
        Else
            ClsLookup.AddItems.AddItemCbb(Voucher.conn, "select inds,text2 from dmitemofcbb where form ='" & Voucherid & "' and name = 'status' order by inds", frmin.cbbstatus, "text2", "inds")
            ClsLookup.AddItems.AddItemCbb(Voucher.conn, "select inds,text2 from dmitemofcbb where form ='" & Voucherid & "' and name = 'ma_gd' order by inds", frmin.cbbma_gd, "text2", "inds")
        End If
