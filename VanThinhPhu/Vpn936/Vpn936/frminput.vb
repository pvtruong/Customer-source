    ...
    Sub Phan_bo_chi_phi()
        ...
        If t_tien <> 0 Then
            ...
            If row_first IsNot Nothing AndAlso cp_nt <> txtt_cp_nt.Value Then
                ...
                row_first.Cells("tien_nhap_nt").Value = row_first.Cells("tien_hang_nt").Value + row_first.Cells("tien_phi_nt").Value + row_first.Cells("thue_nk_nt").Value
                row_first.Cells("tien_nhap").Value = row_first.Cells("tien_hang").Value + row_first.Cells("tien_phi").Value + row_first.Cells("thue_nk").Value
