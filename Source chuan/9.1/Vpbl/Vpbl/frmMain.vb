...
Public Class frmMain
    ...
    Public Sub setup()
        ...
        AddHandler cprint.BeforeShowReport, AddressOf beforeShowReport
    ...
    End Sub
    Private Sub beforeShowReport()
        cprint.SetParameterValue("pbl", cprint.Dataset.Tables(0).Rows(0))
    End Sub
...
s:
    ...
    Private Sub saveHoaDon()
        ...
        For Each r As DataRow In dataDetail.Rows
            ...
            line += 1
        Next
        query = query & Chr(13) & conn.GetInsertQueryFromDatatable(dataDetail, detailtable)
        'conn.Execute(query)
        'save phieu giam gia
        For Each r As DataRow In dataThegiamgia.Rows
            r.Item("stt_rec") = s_stt_rec
        Next
        query = query & Chr(13) & conn.GetInsertQueryFromDatatable(dataThegiamgia, giamgiatable)
        conn.Execute(query)
        'post
