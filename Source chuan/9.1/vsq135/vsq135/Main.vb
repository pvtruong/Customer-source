...
Public Class Frmmain
    ...
    Private Sub dmload(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler Voucher.FormLookups("txtma_kh").AfterLookup, AddressOf afterlookup
        '
    End Sub

    Private Sub afterlookup(row As StpTableRow)
        frmin.txtma_kh.Focus()
        frmin.txtdia_chi.Focus()
    End Sub
    ...
    Private Sub grd_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles grd.RowsAdded
        txtt_tien_nt.Text = Strings.Format(ClsControl2.PropertyOfGrid.Sum(grd, "t_sl"), f_tien_nt)
    End Sub
