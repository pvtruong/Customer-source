...
Public Class Frmmain
    ...
    Private Sub dmload(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Clsql.Others.GetArgu(2) = "" Then
            ...
            list.LoadData(dk)
        Else
            list.LoadData("ma_nv='" & Clsql.Others.GetArgu(2) & "'")
        End If
...
#Region "Thong tin gia dinh"
    ...
    Sub setupttgd()
        ...
        thong_tin_gd.Text = list_lh.oLable("000")


        list_lh.tat.Visible = False
        list_lh.AddToolStripMain(bar_lh)
        '
        PropertyOfForm.SetLable(list_lh.oLable, pantn)
        PropertyOfForm.BindData(list_lh.BindingSource, pantn)
        PropertyOfForm.Sercurity(pantn)
        '
...
#Region "Thong tin hop dong"
    ...
    Sub setuptthd()
        ...
        hop_dong_ld.Text = list_hd.oLable("000")
...
#Region "Thong tin qua trinh cong tac"
    ...
    Sub setupqtct()
        ...
        qtct.Text = list_qtct.oLable("000")

        'set label
        PropertyOfForm.SetLable(list_qtct.oLable, Panqtct)
        PropertyOfForm.BindData(list_qtct.BindingSource, Panqtct)
        PropertyOfForm.Sercurity(Panqtct)
...
#Region "danh muc ho so nhan vien"
    ...
    Sub setupdmhs()
        ...
        dmho_so_nv.Text = list_dmhs.oLable("000")
...
#Region "Thong tin cac khoa dao tao"
    ...
    Sub setupdaotao()
        ...
        dao_tao.Text = list_dt.oLable("000")

        'set label
        PropertyOfForm.SetLable(list_dt.oLable, Pandt)
        PropertyOfForm.BindData(list_dt.BindingSource, Pandt)
        PropertyOfForm.Sercurity(Pandt)
...
#Region "Trinh do chuyen mon"
    ...
    Sub setuptdcm()
        ...
        trinh_do_chuyen_mon.Text = list_tdcm.oLable("000")

        'set label
        PropertyOfForm.SetLable(list_tdcm.oLable, Pantd)
        PropertyOfForm.BindData(list_tdcm.BindingSource, Pantd)
        PropertyOfForm.Sercurity(Pantd)
...
#Region "Dieu chuyen nhan su"
    ...
    Sub AfterAddItem_dcns(ByVal r As DataRow)
        'nv.txtma_bp.Text = r.Item("ma_bp_dc")
        'nv.txtma_cv.Text = r.Item("ma_cv_dc")
        'nv.txtma_cong_viec.Text = r.Item("ma_cong_viec_dc")
        'conn.Execute("update dnv set ma_bp = b.ma_bp_dc,ma_cv = b.ma_cv_dc,ma_cong_viec=b.ma_cong_viec_dc from dnv a left join dmdieuchuyenns b on a.ma_nv=b.ma_nv where b.ngay_bd_lv in (select max(ngay_bd_lv) as ngay_bd_lv from dmdieuchuyenns group by ma_nv)")
    End Sub
    ...
    Sub setupdieuchuyen()
        ...
        dieu_chuyen_nhan_su.Text = list_dcns.oLable("000")

        'set label
        PropertyOfForm.SetLable(list_dcns.oLable, Pandc)
        PropertyOfForm.BindData(list_dcns.BindingSource, Pandc)
        PropertyOfForm.Sercurity(Pandc)
...
#Region "Thong tin qua trinh luong"
    ...
    Sub setupqtluong()
        ...
        qtluong.Text = list_qtluong.oLable("000")
...
#Region "Khen thuong & ky luat"
    ...
    Sub setupktkl()
        ...
        ClsLookup.AddItems.AddItemCbb(list_ktkl.conn, "select * from  dmloaikhenthuong", finktkl.cbbten_loai_qd, "ten_loai_qd", "ten_loai_qd2", "ma_loai_qd")


        khen_thuong.Text = list_ktkl.oLable("000")

        'set label
        PropertyOfForm.SetLable(list_ktkl.oLable, Panktkl)
        PropertyOfForm.BindData(list_ktkl.BindingSource, Panktkl)
        PropertyOfForm.Sercurity(Panktkl)
...
#Region "Thong tin qua trinh dong bhxh"
    ...
    Sub setupqtdong_bhxh()
        ...
        qtdong_bhxh.Text = list_qtdong_bhxh.oLable("000")
...
#End Region
    ...
    Sub loadf()
        ...
        PropertyOfForm.BindData(list.BindingSource, ho_so_luong)
        PropertyOfForm.BindData(list.BindingSource, bao_hiem)

        'PropertyOfForm.BindData(list.BindingSource, qtct)
        'PropertyOfForm.BindData(list.BindingSource, dao_tao)
        'PropertyOfForm.BindData(list.BindingSource, dmho_so_nv)
        'PropertyOfForm.BindData(list.BindingSource, trinh_do_chuyen_mon)
        'PropertyOfForm.BindData(list.BindingSource, dieu_chuyen_nhan_su)
        'PropertyOfForm.BindData(list.BindingSource, khen_thuong)
        ...
        PropertyOfForm.Sercurity(ho_so_luong)
    ...
    Sub setlookup()
        ...
        'Dim odmloainv As New ClsLookup.AutoCompleteLookup(conn, "dmloainv", frmin.txtma_loai_nv, "ma_loai_nv", False)
        'Dim odmbp As New ClsLookup.AutoCompleteLookup(conn, "dmbp", frmin.txtma_bp, "ma_bp", False)

        'If Reg.GetValue("Language") = "Vi" Then

        '    odmbp.SetValue("ten_bp", frmin.ten_bp)
        '    odmloainv.SetValue("ten_loai_nv", frmin.ten_loai_nv)



        'Else
        '    odmbp.SetValue("ten_bp2", frmin.ten_bp)
        '    odmloainv.SetValue("ten_loai_nv2", frmin.ten_loai_nv)
