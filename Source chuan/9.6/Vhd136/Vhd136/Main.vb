...
Public Class Frmmain
    ...
    Function importInvVNPT(stt_rec As String) As String
        ...
        End If
        If conn.GetValue("select status from mhd1 where stt_rec='" & stt_rec & "'") = 9 Then
        ...
        Else
            ...
            conn.Execute("update mhd1 set status='9' where stt_rec='" & stt_rec & "'")
        End If
        Return kq
    End Function
    ...
    Sub postimportfromexcel(ByVal dicstt_rec As Dictionary(Of String, String), ByVal status As Integer)
        For Each stt_rec As String In dicstt_rec.Keys
            ...
            conn.Execute("update mhd1 set ma_so_thue =b.ma_so_thue from mhd1 a join dkh b on a.ma_kh = b.ma_kh where a.ma_so_thue = '' and a.stt_rec ='" & stt_rec & "'")
            conn.Execute("update mhd1 set dia_chi =b.dia_chi from mhd1 a join dkh b on a.ma_kh = b.ma_kh where a.dia_chi = '' and a.stt_rec ='" & stt_rec & "'")
