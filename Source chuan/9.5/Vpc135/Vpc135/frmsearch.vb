...
Public Class frmsearch
    ...
    Private Sub frmsearch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim obpSearch As New ClsLookup.AutoCompleteLookup(Clsql.SQL.newInstance, "dmbp", txtma_bp, "ma_bp", False, False)
        Dim oKhophi As New ClsLookup.AutoCompleteLookup(Clsql.SQL.newInstance, "dmphi", txtma_phi, "ma_phi", False, False)
        Dim oKhodt As New ClsLookup.AutoCompleteLookup(Clsql.SQL.newInstance, "dmdt", txtma_dt, "ma_dt", False, False)


        Dim oNCC2search As New ClsLookup.AutoCompleteLookup(Clsql.SQL.newInstance, "dmkh", txtma_kh, "ma_kh", False, False)
