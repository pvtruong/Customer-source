...
#End Region
    ...
    Dim t_tien, t_ck, t_gc, t_gc_nt, t_thue, t_tt, t_cp, t_sl, t_tien_von, t_tien_nt, t_ck_nt, t_thue_nt, t_tt_nt, t_sl_nt, t_tien_von_nt, t_cp_nt As Double
    ...
    Sub tinh_tong_tien()
        ...
        t_gc_nt = ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "tien_gc_nt")
        t_gc = ClsControl2.PropertyOfGrid.Sum(Voucher.Tabdetails(Voucher.TabFirst).gridDetailKeyin, "tien_gc")
        ...
        txtt_gc.Value = t_gc
        txtt_gc_nt.Value = t_gc_nt
        txtt_tt_nt.Value = t_gc_nt + t_tien_nt
        txtt_tt.Value = t_gc + t_tien
        Txtt_sl.Value = t_sl
    ...
    Sub hide_show_control(ByVal ma_nt As String)
        ...
        If ma_nt.Trim.ToUpper = ma_nt_ht.Trim.ToUpper Then
            ...
            txtt_gc.Hide() 'Visible = False
            txtt_gc_nt.NumberDecimalDigits = Clsql.Others.Options("f_tien", conn)
        ...
        Else
            ...
            txtt_gc.Show() 'Visible = True
            txtt_gc_nt.NumberDecimalDigits = Clsql.Others.Options("f_tien_nt", conn)
        ...
        End If
    End Sub
    Private Sub btnByDinhMucNVL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnbypn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim fdkloc As New frmFindHD2
        fdkloc.Txttu_ngay.Value = Clsql.Reg.GetValue("tu_ngay")
        fdkloc.TxtDen_ngay.Value = Clsql.Reg.GetValue("den_ngay")
        ClsControl2.PropertyOfForm.Lookups(conn, fdkloc, Voucherid)
