...
#End Region
    ...
    Sub loadf()
        ...
        AddHandler Voucher.BeforeEdit, AddressOf kiem_tra_thanh_toan
        AddHandler Voucher.BeforeAdd, AddressOf truoc_khi_add
        ...
        AddHandler Voucher.AfterLoadDetail, AddressOf AfterLoadDetail
        'print
    ...
    Private Sub AfterLoadDetail()
        Voucher.CurrentVoucher("so_seri") = "AA/15P"
    End Sub
