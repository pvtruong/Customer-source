...
Public Class Frmmain
    ...
    Sub beforeedit(ByVal e As String)
        ...
        Dim chx As Integer = conn.GetValue("exec checkpxh " & conn.ConvertToSQLType(grd.CurrentRow.Cells("stt_rec").Value))
        'Dim chx As String = conn.GetValue("exec checkpxh " & conn.ConvertToSQLType(grd.CurrentRow.Cells("stt_rec").Value)).ToString
