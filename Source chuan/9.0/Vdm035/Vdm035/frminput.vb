Public Class frminput
    ...
    Private Sub frminput_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        If isloaded = False Then
            Me.txtma_sp.Focus()
            Me.txtma_sp.SelectionStart = txtma_sp.Text.Length
        End If
    End Sub
...
#End Region
    ...
    End Sub
    Private Sub txtma_dvt_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtma_dvt.Enter

        Voucher.FormLookups("txtma_dvt").oKey = "ma_vt='" & txtma_sp.Text & "'"
    End Sub
