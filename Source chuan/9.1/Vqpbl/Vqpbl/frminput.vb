...
#End Region
    ...
    Private Sub tinhchietkhautheohoadon(ma_kho As String)
        If Not IsDBNull(Voucher.CurrentVoucher("t_tien_ck_hd_changed")) AndAlso Voucher.CurrentVoucher("t_tien_ck_hd_changed") = True Then
            Return
        End If
        If Not IsDBNull(Voucher.CurrentVoucher("ty_le_ck_hd_changed")) AndAlso Voucher.CurrentVoucher("ty_le_ck_hd_changed") = True Then
